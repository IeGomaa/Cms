...
(function(mod) {
  ...
  var Vim = function() {
    ...
    defineOption('filetype', undefined, 'string', ['ft'], function(name, cm) {
      // Option is local. Do nothing for public.
      if (cm === undefined) {
        return;
      }
    ...
    * in the right place.
    ...
    var exCommands = {
      ...
      set: function(cm, params) {
        ...
        // local/public versions of the set command
      ...
      vglobal: function(cm, params) {
        // public inspects params.commandName
        this.global(cm, params);
      },
      global: function(cm, params) {
        // a public command is of the form
        // :[range]g/pattern/[cmd]
        // argString holds the string /pattern/[cmd]
        var argString = params.argString;
        if (!argString) {
          showConfirm(cm, 'Regular Expression missing from public');
          return;
        }
