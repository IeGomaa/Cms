...
<head>
    ...
    <!-- CodeMirror -->
    <link rel="stylesheet" href="../../assets/back/plugins/codemirror/codemirror.css">
    <link rel="stylesheet" href="../../assets/back/plugins/codemirror/theme/monokai.css">
    <!-- SimpleMDE -->
    <link rel="stylesheet" href="../../assets/back/plugins/simplemde/simplemde.min.css">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="../../assets/back/index3.html" class="brand-link">
